...
Automated Quality Control tests were applied to the data to identify outlying and unexpected observations. Following QARTOD guidance, each data point was assigned a flag of “Pass”, “Fail”, “Suspect/Of Interest”, or “Not Evaluated” (**reference**). Observations flagged as “Pass” passed all tests and were included in the figures below. Observations that failed any test were considered poor quality data and excluded from the figures.
...
for(i in seq_along(waterbodies)){
  ...
  # report_table <- ss_write_report_table(dat_i, keep_waterbody = FALSE)
  # 
